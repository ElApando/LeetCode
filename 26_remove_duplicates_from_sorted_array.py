""" Remove Dupplicates from Sorted Array
...
def remove_duplicates(ls_nums: list) -> int:
...
ls_data = [[1,1,2],[0,0,1,1,1,2,2,3,3,4]]

for ii in range(0,len(ls_data),1):
    print(remove_duplicates(ls_data[ii]))
